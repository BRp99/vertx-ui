...
const Sidebar = () => {
  return (
    <aside className="w-64 bg-background border-r desktop:flex flex-col h-full hidden fixed">
      ...
      <div className="h-[50px]  flex items-center">
        <div className="size-[50px] border-t border-r flex items-center justify-center"></div>
      </div>
    </aside>
  )
}
